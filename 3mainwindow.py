...
class SurreyWindow(QMainWindow):
    ...
    def __init__(self,parent=None):
        ...
        self.mainwindow1.mainlayout=QVBoxLayout()
        self.mainwindow1.mainlayout.addWidget(a1)
        self.mainwindow1.setLayout(self.mainwindow1.mainlayout)

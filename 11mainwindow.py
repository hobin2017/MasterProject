...
class SurreyWindow(QMainWindow):
    def __init__(self,parent=None):
        ...
        self.stacklayout.addWidget(self.tableviewer2)
        self.stacklayout.addWidget(self.tableviewer3)
        self.stacklayout.addWidget(self.tableviewer4)
        self.stacklayout.addWidget(self.tableviewer5)
        self.stacklayout.addWidget(self.tableviewer6)
        self.stacklayout.addWidget(self.blankwidget)
        self.stacklayout.setCurrentWidget(self.blankwidget)
        #

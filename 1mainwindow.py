...
class SurreyWindow(QMainWindow):
    ...
    def __init__(self,parent=None):
        ...
        self.dockwindow1.a4=Partition_Diffusion_Coefficient()
        self.dockwindow1.a5=CompartmentSetup()
        ...
        self.dockwindow1.z2=QHBoxLayout()
        self.dockwindow1.z2.addLayout(self.dockwindow1.z1)
        self.dockwindow1.z2.addWidget(self.dockwindow1.a4)
        self.dockwindow1.z2.addWidget(self.dockwindow1.a5)
        self.dockwindow1.mainwidget=QWidget() #因为用到QDockWidget的setWidget方法
        self.dockwindow1.mainwidget.setLayout(self.dockwindow1.z2)
